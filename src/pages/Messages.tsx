  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 w-full px-2 sm:px-4 py-4 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row gap-4 min-h-[500px] md:min-h-[calc(100vh-270px)]">
          {/* Sidebar */}
          <Card className="w-full md:flex-[1.1]">
            <CardHeader>
            ...
            <CardContent className="p-0">
              <div className="space-y-1 overflow-y-auto max-h-[400px] md:max-h-full">
          ...
          {/* Chat Window */}
          <Card className="w-full md:flex-[2] flex flex-col">
            ...
            <CardContent className="flex-1 overflow-y-auto p-4 space-y-4 max-h-[350px] md:max-h-full">
      ...
      <footer className="bg-[#101626] text-white p-6 sm:p-8 mt-auto">
